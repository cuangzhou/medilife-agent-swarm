...
python3 -m verl.trainer.main \
    ...
    data.train_files=../data/medilife-rl-data/data@train \
    data.val_files=../data/medilife-rl-data/data@test \
    ...
    trainer.experiment_name=medilife-r1_2b_dapo \
    trainer.total_epochs=2 \
    trainer.val_generations_to_log=15 \
    trainer.val_before_train=False \
    worker.rollout.n=3 \
    trainer.save_checkpoint_path=./checkpoints/medilife-r1_2b_dapo \
