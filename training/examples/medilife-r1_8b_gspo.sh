...
python3 -m verl.trainer.main \
    ...
    data.train_files=MBZUAI/medilife-rl-data@train \
    data.val_files=MBZUAI/medilife-rl-data@test \
    ...
    trainer.experiment_name=medilife-r1_8b_gspo \
    trainer.total_epochs=2 \
    trainer.val_generations_to_log=15 \
    trainer.val_before_train=False \
    worker.rollout.n=5 \
    trainer.save_checkpoint_path=./checkpoints/medilife-r1_8b_gspo \
