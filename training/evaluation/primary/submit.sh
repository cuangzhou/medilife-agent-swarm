...
#   bash submit.sh "MBZUAI/MediLife-R1-8B"        # specify model explicitly
...
if [ -z "$1" ]; then
    ...
    echo ""
    echo "Example:"
    echo "  bash submit.sh \"MBZUAI/MediLife-R1-8B\""
    exit 1
fi
...
echo "    https://medilife.cvmbzuai.com/leaderboard"
echo ""
echo "  Project page: https://medilife.cvmbzuai.com"
echo "================================================"
