...
#
# 将 training/checkpoints/medilife-r1_2b_dapo/global_step_600/actor/ 下的
...
ACTOR_DIR="${PROJECT_ROOT}/MediLife-R1/training/checkpoints/medilife-r1_2b_dapo/global_step_600/actor"
...
cd "${PROJECT_ROOT}/MediLife-R1/training"
