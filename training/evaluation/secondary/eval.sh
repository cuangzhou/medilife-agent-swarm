#!/bin/bash
# eval.sh - 评估 medilife-r1_2b_dapo checkpoint 在 rad_vqa 上的表现
#
# 使用方式:
#   1. 先合并模型权重 (如果还没合并过): bash merge.sh
#   2. 运行评估: bash eval.sh
#
# rollout 模型: MediLife-R1/training/checkpoints/medilife-r1_2b_dapo/global_step_600 (本地 vLLM)
...
# 合并后的模型路径
MODEL_PATH="${PROJECT_ROOT}/MediLife-R1/training/checkpoints/medilife-r1_2b_dapo/global_step_600/actor/huggingface"
